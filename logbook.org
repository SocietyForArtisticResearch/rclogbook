...
*** TODO Fix multilingual abstracts
...
*** TODO Make downloading big exports more fail safe: big expositions cause timeouts, like https://www.researchcatalogue.net/view/568007/568008 
*** TODO When user uploads a video with a problematic resolution, show user hint what would work.
*** TODO add grouping tags for users within portal user list (for organising)
*** TODO Publication tags for exposition, to separate it from keywords
*** TODO merge keywords of expositions and media repo
*** TODO make the media repo github repository public (clean up old state first)
*** TODO duplicate page command within editors (instead of copy paste tools)
*** TODO Work migration to media repo set
*** TODO fix "add all" button in collaboration message dialog
*** TODO collaboration notifications removed from messages, should be prompt or notification. State should be live from the current state
*** TODO Picture tool should use tool default instead of intrensic size 
*** TODO duplicate accounts (automatic detection)
...
*** TODO Media url's in text-based editor, not always translated to live url (https://www.re catalogue.net/text-editor/simple-media-resource?research=547070&simple-media=945677)
