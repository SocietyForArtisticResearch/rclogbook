...
** stronger warning on self-publication. 
...
** text tools size warnings
   current lack of limits stimulates risky designs
...
**** Discussion: How to open them? Menu options? Double-click and 2nd button click are not preferred.
...
** Front page, abstracts should be cropped to ellipses.
** When dragging from simple media: should use tool default instead of intrinsic size
