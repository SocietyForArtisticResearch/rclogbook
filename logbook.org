...
** Ideas
*** Stronger warning on self-publication. Inform user on DOI being created, and that this means that the reference is permanent.magit
...
*** Supervised expositions whow up in two places: Research Exposition (collaborated) and Research Expositions.
